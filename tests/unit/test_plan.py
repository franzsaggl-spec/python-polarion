...
def test_eq_different_id(mock_polarion, mock_project, mock_plan_data):
    ...
    other_data = _zeep_object({
        ...
        'dueDate': None, 'startDate': None, 'finishedOn': None,
        'startedOn': None, 'records': None, 'parent': None,
        'allowedTypes': None, 'template': None, 'description': None,
        'color': None, 'projectURI': None, 'calculationType': None,
        'capacity': None, 'defaultEstimate': None,
        'estimationField': None, 'prioritizationField': None,
        'sortOrder': None, 'status': None,
    })

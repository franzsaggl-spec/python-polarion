...
from polarion.xml import Config, Importer, XmlParser
...
class TestPolarionJunit(unittest.TestCase):
    ...
    def test_regular_expression(self):
        test1 = {
            ...
            """,
            "result": [{"name": "verifies", "value": "REQ-001"}, {"name": "verifies", "value": "REQ-002"}],
        }
        test2 = {
            "value": """
            Output line #1
            ...
            Output line #3
            """,
            "result": [{"name": "relates_to", "value": "REQ-002"}],
        }
        ...
        test3 = {
            ...
            """,
            "result": [{"name": "verifies", "value": "ISSUE-001"}],
        }
